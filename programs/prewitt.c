...
int main(void) {
    ...
    int filter1[9]={-1,0,1,-1,0,1,-1,0,1};
    int filter2[9]={-1,-1,-1,0,0,0,1,1,1};
if(data){
	...
	for(j=0;j<width;j++){
		...
		printf("Check the images folder for prewitt_x.png, prewitt_y.png and Final_prewitt.png\n");
	stbi_write_png("../images/prewitt_x.png", width, height, 1, rgb_imagex, width*1);
	stbi_write_png("../images/prewitt_y.png", width, height, 1, rgb_imagey, width*1);
	stbi_write_png("../images/Final_prewitt.png", width, height, 1, rgb_imagez, width*1);
